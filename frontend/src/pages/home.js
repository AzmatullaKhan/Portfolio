...
export const Home = () => {
      ...
      const interval = setInterval(() => {
        ...
        if (skipCount === 0) {
          setOffset((prevOffset) =>
            forwards ? prevOffset + 1 : prevOffset - 1
          );
        }
      }, speed);
  ...
  const handleHidden = () => {
    if (i % 2 === 0) setHidden(true);
    else setHidden(false);
    setI(i + 1);
  };
  const [seePG, setSeePG] = useState(true);
  const hideGame = (e) => {
    setSeePG(false);
  };
  const showGame = (e) => {
    ...
    <div>
      ...
      <div className="main">
        <div className="mini-main">
          ...
          <h1
            className="book-head"
            onMouseEnter={hideGame}
            onMouseLeave={showGame}
          >
            Azmatulla Khan
            <center>
              <br></br>
          ...
          <AboutMe />
          <h1 className="book-desc">
            I am interested<br></br>in full stack <br></br>development and{" "}
            <br></br> Software Devops
          </h1>
          ...
          <div style={{ display: "flex" }}>
            ...
            <a
              href="https://www.instagram.com/01__suspect/"
              className="instagram"
            >
              Instagram
            </a>
          ...
          <div style={{ display: "flex" }}>
            ...
            <a
              href="https://www.linkedin.com/in/azmatulla-khan-259338246/"
              className="linkedIn"
            >
              LinkedIn
            </a>
          ...
          <div style={{ display: "flex" }}>
            ...
            <a href="https://github.com/AzmatullaKhan" className="github">
              GitHub
            </a>
          </div>
          ...
          <a
            href="https://github.com/AzmatullaKhan"
            className="document-takeMe"
          >
            Take me
          </a>
          <a
            href="https://github.com/AzmatullaKhan/Movie_TV_Show_Recommendation_System"
            className="document-project1 document-takeMe"
          >
            1. Movies Website
          </a>
          <a
            href="https://github.com/AzmatullaKhan/Tourism-And-Hospitality-Management-ReactProject"
            className="document-project2 document-takeMe"
          >
            2. Hotel Website
          </a>
          <a
            href="https://github.com/AzmatullaKhan/Portfolio"
            className="document-project3 document-takeMe"
          >
            3. Portfoli(current)
          </a>
          <a
            href="https://github.com/AzmatullaKhan/Internship_Swecha-Project"
            className="document-project4 document-takeMe"
          >
            4. Map of India
          </a>
